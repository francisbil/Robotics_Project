...
/*il manquera juste a ajouter les autres .cpp pour les LED ou moteurs par exemple qu'on aura de beso
 * Classe can:
 *   Le constructeur initialise le convertisseur.
 *   Une lecture enclanche une conversion et le resultat
 *   est retourne sur 16 bits.il manquera juste a ajouter les autres .cpp pour les LED ou moteurs par exemple qu'on aura de beso
 *
 */
